...
const Home = () => {
  return (
    <div className="bg-gray-100 min-h-screen pt-[30px] md:pt-[70px]">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-[23px] p-[15px] md:p-[0px] mx-auto max-w-screen-sm md:max-w-screen-lg">
        <div className="relative bg-white md:col-span-2 px-[28px] py-[28px]">
          <span className="absolute right-[10px] top-[65px] md:right-[40px] md:top-[40px]">
          ...
          <p className="font-rubik text-[18px] font-normal leading-140 tracking-tighter text-[#62666E]">
            {"You're still"} <strong>ON TARGET</strong>.
            {
              "Your progress is currently at 90% for completing the entire quiz."
            }
          </p>
          ...
          <div class="flex flex-wrap border border-1 border-[#E4E5E8] items-center justify-between px-[28px] py-[24px] rounded-lg">
            ...
            <button
              disabled
              class="w-full md:w-[130px] mt-[20px] md:mt-[0px] blur flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg"
            >
              <img
              ...
              return (
                <div key={index}>
                  ...
                  <hr
                    ...
                    } border-gray-300 mt-[12px] mb-[12px] md:mb-[0px]`}
                  />
                </div>
              );
            })}
